...
namespace KM_KT3120.Tests
{
    ...
    {
        public readonly DbContextOptions<KondratevDbContext> _dbContextOptions;
        public StudentIntegrationTests()
        {
            _dbContextOptions = new DbContextOptionsBuilder<KondratevDbContext>()
        ...
        {
            // Arrange
            //var _dbContextOptions = new DbContextOptionsBuilder<KondratevDbContext>().Options;

            var ctx = new KondratevDbContext(_dbContextOptions);
            //  var ctx = new KondratevDbContext(_dbContextOptions);
            ...
            // Act
            var filter = new KM_KT3120.Filters.StudentFilters.StudentGroupFilter
            {
                GroupName = "KT-31-20"
            };
